        ...
        <div class="border-b border-gray-900/10 pb-12">
            ...
            <hr class="border-top border-indigo-300 mx-12">
                    ...
                    <div class="col-span-full">
                        ...
                        <div class="mt-2">
                            <input value="<?php if(isset($_SESSION['user']['address']) && !empty($_SESSION['user']['address'])) { echo $_SESSION['user']['address']['street']; }?>" type="text" name="street" id="street" autocomplete="street-address" class="px-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                        </div>
                    </div>
                    ...
                    <div class="col-span-half">
                        ...
                        <div class="mt-2">
                            <input value="<?php if(isset($_SESSION['user']['address']) && !empty($_SESSION['user']['address'])) { echo $_SESSION['user']['address']['house_number']; }?>" type="text" name="house_number" id="house_number" autocomplete="house_number" class="px-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                        </div>
                    </div>
                    <div class="col-span-half">
                        <label for="bus_number" class="block text-sm font-medium leading-6 text-gray-900">Bus Number</label>
                        <div class="mt-2">
                            <input value="<?php if(isset($_SESSION['user']['address']) && !empty($_SESSION['user']['address'])) { echo $_SESSION['user']['address']['bus_number']; }?>" type="text" name="bus_number" id="bus_number" autocomplete="bus_number" class="px-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-2 sm:col-start-1">
                        ...
                        <div class="mt-2">
                            <input value="<?php if(isset($_SESSION['user']['address']) && !empty($_SESSION['user']['address'])) { echo $_SESSION['user']['address']['city']; }?>" type="text" name="city" id="city" autocomplete="city" class="px-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <div class="mt-2">
                            <input value="<?php if(isset($_SESSION['user']['address']) && !empty($_SESSION['user']['address'])) { echo $_SESSION['user']['address']['zip_code']; }?>" type="text" name="zip_code" id="zip_code" autocomplete="zip_code" class="px-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                        </div>
                    </div>
